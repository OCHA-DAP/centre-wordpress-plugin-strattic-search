...
<?php
	...
	while ( have_posts() ) : the_post();
		...
		if ($page_header_type !== '' && $page_header_type !== 'none') {
			...
			$metabox_data['_uncode_header_style'][0] = 'dark';
			$metabox_data['_uncode_header_align'][0] = 'center';
...
$content_after_body = get_the_content();

$content_after_body = '
			<div class="row no-top-padding no-bottom-padding no-h-padding full-width row-parent" data-imgready="true">
				<div class="row-inner">
						...
						<div class="uncol style-light">
							<div class="uncoltable">
								<div class="uncell  boomapps_vccolumn no-block-padding">
									<div class="uncont">
										<div id="index-191444" class="isotope-system isotope-general-light">
											<div class="isotope-wrapper single-gutter">
												<div class="isotope-container isotope-layout style-metro isotope-pagination" data-type="metro" data-layout="fitRows" data-lg="1000" data-md="600" data-sm="480" style="position: relative; height: 1116px; opacity: 1;">
													' . $content_after_body . '
												</div>
											</div>
										</div>
	...
	<div class="post-wrapper">
		<div class="post-body">
			...
			<div class="post-content">
				<div data-parent="true" class="style-color-wayh-bg row-container boomapps_vcrow" data-section="0">
					<div class="row no-top-padding no-bottom-padding no-h-padding full-width row-parent" data-imgready="true">
						<div class="row-inner">
							<div class="pos-top pos-center align_left column_parent col-lg-12 boomapps_vccolumn single-internal-gutter">	<div class="uncol style-light">
									<div class="uncoltable">
										<div class="uncell  boomapps_vccolumn no-block-padding">
											<div class="uncont">
												<div id="index-191444" class="isotope-system isotope-general-light">
							...
							<script id="script-204291" type="text/javascript">UNCODE.initRow(document.getElementById("script-204291"));</script>
						</div>
					</div>
				</div>
			</div>
